<template>
  <div id="notes" v-bind:class="{ focused: focused }">
    <Titlebar focused="focused" @update-focus="update" />
    <div id="notes-content" v-on:click="this.focused = true">
      <div id="side">
        <p>FH Dortmund</p>
        <ul>
          <li>Bachelor</li>
      ...
      <div id="notess">
        ...
        <div id="content">
          ...
          von Ausstellungen, Installationen oder in Buch- und Magaznotesrmen zu
